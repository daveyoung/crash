...
"[-b bio | -d | -l | -q | -s | -t]",
"NAME",
"       crash-dminfo - device mapper (dm) information",
"",
"SYNOPSIS",
"       dminfo [-b bio | -d | -l | -q | -s | -t]",
"",
"DESCRIPTION",
"       This command displays information about device-mapper mapped devices (dm",
"       devices).  If no argument is entered, displays lists of existing dm",
"       devices.  It's same as -l option.",
"",
"       -b bio displays the information of the dm device which the bio is",
"              submitted in.  If the bio isn't for dm devices, results will be",
"              error.",
"",
...
"",
"       -q     displays queued I/O information for each target of existing dm",
"              devices.",
"",
"       -s     displays status information for each target of existing dm",
"              devices.",
"",
"       -t     displays table information for each target of existing dm",
"              devices.",
"",
"EXAMPLES",
"       Display lists of dm devices.  \"MAP_DEV\" is the address of the struct",
"       mapped_device.  \"DM_TABLE\" is the address of the struct dm_table.",
"       \"TARGETS\" is the number of targets which are in the struct dm_table.",
"           crash> dminfo",
...
"",
"       Display the dm device information which the bio is submitted in.  The",
"       bio (ceacee80) is a clone of the bio (ceacee00) which is submitted in",
"       the dm-3 (dummy0).  And the bio (ceacee00) is a clone of the bio",
"       (ceaced80) which is submitted in the dm-4 (dummy1), too.  The bio",
"       (ceaced80) is the original bio.",
...
"",
"       Display dependency information for each target.  The vg0-snap0 depends",
"       on thd dm-6 (vg0-lv0-real) and the dm-7 (vg0-snap0-cow)",
"           crash> dminfo -d",
"           MAJ  MIN  MAP_DEV           DM_TABLE          TARGETS  MAPNAME",
"           253  8    c4866c80          c4866280          1        vg0-snap0",
"",
...
"             253  6    f6a04280          1      dm-6",
"",
"       Display queued I/O information for each target.  The information is",
"       displayed under the \"PRIVATE_DATA\" column.",
"           crash> dminfo -q",
"           MAJ  MIN  MAP_DEV           DM_TABLE          TARGETS  MAPNAME",
"           253  5    f7c50c80          c488e480          1        via_cbeheddbdd",
...
"",
"       Display status information for each target.  The information is",
"       displayed under the \"PRIVATE_DATA\" column.",
"           crash> dminfo -s",
"           MAJ  MIN  MAP_DEV           DM_TABLE          TARGETS  MAPNAME",
"           253  0    c4840380          c4841880          1        mp0",
...
"",
"       Display table information for each target.  The information is displayed",
"       under the \"PRIVATE_DATA\" column.",
"           crash> dminfo -t",
"           MAJ  MIN  MAP_DEV           DM_TABLE          TARGETS  MAPNAME",
"           253  8    c4866c80          c4866280          1        vg0-snap0",
"             TARGET            TARGET_TYPE  PRIVATE_DATA",
