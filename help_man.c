...
"",
"SYNOPSIS",
"files [-d dentry] | [-p inode] | [-n inode]|[-c] [-R reference] [pid | taskp] ...",
"",
"DESCRIPTION",
...
"",
"SYNOPSIS",
"kmem [-f|-F|-c|-C|-i[=shared]|-v|-V|-n|-z|-o|-h] [-p | -m member[,member]]",
...
"        be recognized and used automatically during subsequent crash sessions.",
...
"        have to be added to the crash command line during invocation.",
"",
"EXAMPLES",
"    crash> map",
...
"",
"SYNOPSIS",
"ps [-k|-u|-G|-I|-y policy] [-s] [-p|-c|-t|-[l|m][-C cpu]|-a|-g|-r|-S|-A|-H|-Y]",
"     [pid | task | command] ...",
"",
"DESCRIPTION",
